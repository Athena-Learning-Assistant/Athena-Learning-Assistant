...
import com.haikal.athena.databinding.FragmentScreen3Binding
...
class Screen3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnBack.setOnClickListener {
            ...
            viewPager.currentItem = 1 // Kembali ke Screen1Fragment (indeks 0)
        }

        binding.btnNext.setOnClickListener {
            val viewPager = requireActivity().findViewById<ViewPager2>(R.id.viewPager)
            viewPager.currentItem = 3 // Pindah ke Screen2Fragment (indeks 1)
        }
